...
class AppDatabase {
  ...
  Future _createTappaTable(Database db) {
    return db.transaction((Transaction txn) async {
      ...
      txn.rawInsert('INSERT INTO '
          '${Tappe.tblTappa} (${Tappe.dbId},${Tappe.dbTitle},${Tappe.dbLat},${Tappe.dbLng},${Tappe.dbPercorsoID},${Tappe.dbStatus},${Tappe.dbLastTappa}, ${Tappe.dbDescription}, ${Tappe.dbIndicazioni},  ${Tappe.dbEsplorazione}, ${Tappe.dbImage})'
      ...
      txn.rawInsert('INSERT INTO '
          ...
          '"Nel 2015 il Comune di Carvico, in collaborazione con l’Associazione Camminiamo Insieme Onlus e Agenda21 Isola Dalmine-Zingonia, ha destinato questa grande area verde a frutteto sociale, un modo con cui la comunità si prende cura del proprio territorio.",'
          '"",'
          '"Sfumature di colore: stai fermo in posto per qualche minuto, guardati intorno e conta tutti i colori che riesci a trovare. E quante sfumature dello stesso colore riesci a vedere?",'
      ...
      txn.rawInsert('INSERT INTO '
          '${Tappe.tblTappa} (${Tappe.dbId},${Tappe.dbTitle},${Tappe.dbLat},${Tappe.dbLng},${Tappe.dbPercorsoID},${Tappe.dbStatus},${Tappe.dbLastTappa}, ${Tappe.dbDescription}, ${Tappe.dbIndicazioni},  ${Tappe.dbEsplorazione}, ${Tappe.dbImage})'
          ' VALUES(1007, "Arrivo_Ponte", 45.707994, 9.491417, 1, 0, 0,'
          '"Continuando a seguire la strada, in pochi minuti puoi raggiungere il Comune di Sotto il Monte, paese natale di Papa Giovanni XXIII; qui è possibile visitare la sua casa natale e altri luoghi importanti legati alla sua infanzia.",'
          '"",'
      ...
      txn.rawInsert('INSERT INTO '
          ...
          '"Il nome di questa frazione non è casuale. Non per niente nei boschi del Monte Canto potresti incontrare delle antiche ruote di pietra, identificabili come delle macine. Ricoperte dal muschio, osservatele da vicino e provate a immaginare come dovevano essere questi luoghi tantissimi anni fa.",'
      ...
      txn.rawInsert('INSERT INTO '
          '${Tappe.tblTappa} (${Tappe.dbId},${Tappe.dbTitle},${Tappe.dbLat},${Tappe.dbLng},${Tappe.dbPercorsoID},${Tappe.dbStatus},${Tappe.dbLastTappa}, ${Tappe.dbDescription}, ${Tappe.dbIndicazioni},  ${Tappe.dbEsplorazione}, ${Tappe.dbImage})'
          ' VALUES(2006, "Arrivo_Località Valle (Villa d’Adda)", 45.717972, 9.471278, 2, 0, 0,'
      ...
      txn.rawInsert('INSERT INTO '
          '${Tappe.tblTappa} (${Tappe.dbId},${Tappe.dbTitle},${Tappe.dbLat},${Tappe.dbLng},${Tappe.dbPercorsoID},${Tappe.dbStatus},${Tappe.dbLastTappa}, ${Tappe.dbDescription}, ${Tappe.dbIndicazioni},  ${Tappe.dbEsplorazione}, ${Tappe.dbImage})'
          ' VALUES(3004, "Esplorazioni", 45.713556, 9.477972, 3, 0, 0,'
          '"",'
          '"",'
      ...
      txn.rawInsert('INSERT INTO '
          '${Tappe.tblTappa} (${Tappe.dbId},${Tappe.dbTitle},${Tappe.dbLat},${Tappe.dbLng},${Tappe.dbPercorsoID},${Tappe.dbStatus},${Tappe.dbLastTappa}, ${Tappe.dbDescription}, ${Tappe.dbIndicazioni},  ${Tappe.dbEsplorazione}, ${Tappe.dbImage})'
          ' VALUES(3005, "Arrivo_Campanile di Fontanella", 45.714750, 9.513528, 3, 0, 0,'
